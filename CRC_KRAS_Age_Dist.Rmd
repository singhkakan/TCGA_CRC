...
dge = DGEList( # creating a DGEList object
  ...
  design = model.matrix(~factor(crc_data@colData$definition)),
...
KDR_clinical <- crc_data@colData[,c("sample_type", "patient", "barcode")]
...
ggplot(KDR_dataset, aes(x=sample_type, y=log10(`assay(crc_data)["ENSG00000128052.10", ]`))) +
  geom_boxplot(aes(colour = sample_type, fill=patient)) +
