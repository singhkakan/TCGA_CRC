...
pt_id_age <- as.data.frame(cbind(crc_data@colData$patient, crc_data@colData$age_at_index, crc_data@colData$age_at_diagnosis, crc_data@colData$gender))
colnames(pt_id_age) <- c("patient", "age_at_index", "age_at_diagnosis", "gender")
...
ggplot(crc_mut_sub2, aes(x=age_at_diagnosis, color=Hugo_Symbol)) +
